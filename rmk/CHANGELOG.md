...
- Keep the 125 Hz BLE split pointing cadence local to the peripheral link that actually carries the pointing device
- Send only the serialized split-message prefix over BLE, keep keyboard activity link-local, and avoid repeated pointing-interval renegotiation during normal cursor pauses
