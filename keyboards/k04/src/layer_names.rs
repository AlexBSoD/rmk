...
const SETTING_KEYS: [u16; 83] = [
    ...
    320, 321, 322, 324, 325, 326, 327, 328, 329, 330, 331, 332, 333, 334,
];
...
const DEFAULT_ACCELERATION_FLAGS: u8 = FLAG_LEFT_ACCELERATION | FLAG_RIGHT_ACCELERATION;
...
fn module_qsid_width(qsid: u16) -> Option<usize> {
    match qsid {
        120..=152 | 300..=315 | 317..=334 => Some(1),
        316 => Some(2),
        _ => None,
    }
}
